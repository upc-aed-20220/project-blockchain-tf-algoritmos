...
struct Usuario
{
    ...
    void ingresarTransaccionEmitida(Transaccion trans){
        transaccionesEmitidas->push_back(trans);
    }
    void ingresarTransaccionRecibida(Transaccion trans){
        transaccionesRecibidas->push_back(trans);
    }
